            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ps-3 <?php echo (isset($_GET['x']) && $_GET['x'] == 'buku') ? 'active link-light' : 'link-dark'; ?>" href="buku.php"><i class="bi bi-cart4"></i> Daftar Buku</a>
                        </li>
                        <?php }?>

                        <?php if($hasil['level']==1) { ?>
                        <li class="nav-item">
                            <a class="nav-link ps-3 <?php echo (isset($_GET['x']) && $_GET['x'] == 'katmenu') ? 'active link-light' : 'link-dark'; ?>" href="katmenu"><i class="bi bi-tags"></i> Kategori Buku</a>
                        </li>
                        <?php }?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link ps-3 <?php echo (isset($_GET['x']) && $_GET['x'] == 'order') ? 'active link-light' : 'link-dark'; ?>" href="Pesanan.php"><i class="bi bi-cart4"></i> Pesanan</a>
                        </li>
                        <?php }?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link ps-3 <?php echo (isset($_GET['x']) && $_GET['x'] == 'dapur') ? 'active link-light' : 'link-dark'; ?>" href="gudang.php"><i class="bi bi-fire"></i> Gudang</a>
                        </li>
                        <?php } ?>
