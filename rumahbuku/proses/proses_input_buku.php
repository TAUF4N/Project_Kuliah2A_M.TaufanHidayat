    ...
    window.location="../menu"</script>
        ...
        window.location="../buku"</script>';
            ...
            if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
                $query = mysqli_query($conn, "INSERT INTO tb_daftar_buku (foto,nama_buku,keterangan,kategori,harga,stok) values('" . $kode_rand . $_FILES["foto"]["name"] . "','$nama_buku','$keterangan','$kat_buku','$harga','$stok')");
                if ($query) {
